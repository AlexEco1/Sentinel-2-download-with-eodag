...
def main():
    ...
    # Polygon of AOI (as copied from Copernicus Browser) and then transformed in WKT format
    POLYGON = {"type":"Polygon","coordinates":[[[22.898254,39.272663],[22.898254,39.405428],[23.069916,39.405428],[23.069916,39.272663],[22.898254,39.272663]]]}
    WKT_F = shape(POLYGON)
    ...
    COP_USERNAME = os.getenv("COP_USERNAME")
    COP_PASSWORD = os.getenv("COP_PASSWORD")
    ###############################################################################
